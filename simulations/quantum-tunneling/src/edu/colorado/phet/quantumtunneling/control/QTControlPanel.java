...
public class QTControlPanel extends QTAbstractControlPanel {
    ...
    private JCheckBox _pdvCheckBox;
    ...
    public QTControlPanel( QTModule module ) {
        ...
        JPanel probabilityPanel = new JPanel();
        {
            ...
            _pdvCheckBox = new JCheckBox( QTResources.getString("label.pdValues"));
            ...
            layout.addComponent(_pdvCheckBox, 1, 1);
        ...
        // Interactivity
        {
            ...
            _pdvCheckBox.addActionListener(_listener);
    ...
    /**
     * Determines whether the "probability density values" checkbox is checked.
     * @param selected
     */
    public void setPdvSelected(boolean selected) {
        _pdvCheckBox.setSelected(selected);
        handlePdvSelection();
    }
    ...
    /**
     * Is the "probability density values" checkbox checked?
     * @return
     */
    public boolean isPdvSelected() {
        return _pdvCheckBox.isSelected();
    }
    ...
    private void handlePdvSelection() {
        _module.setPdvVisible(_pdvCheckBox.isSelected());
    }
}
