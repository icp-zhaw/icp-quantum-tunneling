...
public abstract class AbstractProbabilityNode extends PText implements Observer {
    ...
    /**
     * ProbabilityDensityValueNode displays the probability of quantum particle being in a certain area of the probability density plot.
     */
    public static class ProbabilityDensityValueNode extends AbstractProbabilityNode {

        private int _regionIndex;

        public ProbabilityDensityValueNode(int regionIndex) {
            super(QTResources.getChar("char.probabilityDensityValue", 'P'));
        ...
        public void update() {
            if(getVisible()) {
                double value = getWave().getProbabilityDensityValue(_regionIndex);
                //setValue(value);
